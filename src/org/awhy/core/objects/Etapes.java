...
public class Circuit implements Object {
	...
	public Circuit(String idCircuit, int ordre, String nomLieu,
	...
	public Object createFromSQL(ResultSet res) throws SQLException {
		return new Circuit(res.getString(1), res.getInt(2), res.getString(3), res.getString(4), res.getString(5), res.getInt(6));
	}
