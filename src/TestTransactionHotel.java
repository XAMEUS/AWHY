...
//test Création
//		Hotel h = new Hotel("GBH", "Budapest", "Hongrie", "1 rue ", 100, 200, 20);
...
//test createfromSQL
//		ResultSet res = d.executeQuery("select * from Hotel where nomHotel='GBH'");
//		Hotel h = null;
//		if (res.next())
...
//Test updateSQL		
//		Hotel h = new Hotel("GrandBudapestHotel", "Budapest", "Hongrie", "1 rue ", 100, 200, 20);
//		h.updateSQL(d.getConnection());
//		d.getConnection().commit();		

		
		
//		ResultSet res = d.executeQuery("select * from Hotel where nomHotel='GBH', ville='Budapest', pays='Hongrie'");
//		Hotel h = null;
//		if (res.next())
