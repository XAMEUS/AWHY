...
\noindent\textsc{\textcolor{dorure2}{\section{Introduction}}}

L'agence de voyage \textsc{AWHY}, forte de son succès, entreprend sa transformation numérique.

Elle tient à numériser ses outils de gestion tout en conservant une étroite collaboration avec ses partenaires. De ce fait, certaines règles d'implémentation devront être respectées afin d'assurer le fonctionnement des outils numériques et la compatibilité des bases de données communes entre tous les partenaires.\\
...
\noindent\textsc{\textcolor{dorure2}{\section{Analyse du problème}}}

L'application doit proposer deux vues :
\begin{itemize}
\item une vue \textit{client} permettant au client de créer sa simulation et d'obtenir un numéro de dossier, puis de pouvoir consulter le catalogue de l'agence et ajouter à sa simulation des hôtels, des lieux à visiter et des circuits, et enfin confirmer sa simulation. Il se pourra alors se présenter à l'agence avec son numéro de dossier et effectuer sa réservation.
...
Il sera également vital de permettre à ce que de multiples utilisateurs se connectent à la base de donnée via l'application et modifie la base de donnée par ajout de simulation, de réservation ou de clients sans conflit.
...
\vspace{0.3cm}
\textsc{\textcolor{dorure}{\subsection{Contraintes de valeur}}}
\vspace{0.3cm}
...
\textsc{Issues du schéma relational fourni :}
\vspace{0.3cm}
...
\textsc{\textcolor{dorure}{\subsection{Autres contraintes}}}
...
\textsc{\textcolor{dorure2}{\section{Schéma Entité-Association}}}


\newpage
\textsc{\textcolor{dorure2}{\section{Passage au relationnel}}}

\textsc{\textcolor{dorure}{\subsection{Types d'entité simple}}}
...
\textsc{\textcolor{dorure}{\subsection{Types d'entité faible}}}
...
\textsc{\textcolor{dorure}{\subsection{Sous-types d'entité}}}
...
\textsc{\textcolor{dorure}{\subsection{Associations}}}
...
\textsc{\textcolor{dorure}{\subsection{Formes normales}}}
...
\textsc{\textcolor{dorure2}{\section{Analyse des fonctionnalités}}}
...
\textsc{\textcolor{dorure2}{\section{Bilan du projet}}}

\textsc{\textcolor{dorure}{\subsection{Organisation}}}
...
Les semaines 1 à 3 ont été dédiées à définir et réfléchir de manière collective aux fondations de notre base de données. Le script de création de la base de donnée a également été réalisé en groupe. A partir de la semaine 4, le développement s'est effectué en parallèle. Chaque personne était dédiée à une tâche entre les scripts de peuplement de la base de donnée, l'implémentation des transactions et le développement de l'application. La base de donnée étant bien en place la semaine 5, toute l'équipe s'est alors concentrée sur l'application afin de réaliser toutes les fonctionnalités identifiées. A l'issue de cette semaine, la documentation a été rédigée et la soutenance préparée.
...
\textsc{\textcolor{dorure}{\subsection{Difficultés rencontrées}}}

\textsc{Analyse du sujet, attentes du client :}
\vspace{0.3cm}

Nous avons rencontrée une difficulté majeure tout au long du projet étant l'analyse du sujet. Malgré de nombreuses questions posées à l'expert technique et au client ainsi qu'aux autres équipes sur le projet, nous avons continué tout au long du projet à nous poser des questions relatives aux attentes de l'agence AWHY vis-à-vis de notre produit.
...
\textsc{\textcolor{dorure}{\subsection{Ressenti final de l'équipe}}}
